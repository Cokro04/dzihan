                ...
                <tbody>
                    ...
                    ?>
                            <tr>
                                ...
                                <td><?= $b['nama_barang']; ?></td>
                                <td><?= $b['nama_jenis']; ?></td>
                                <td><?= $this->admin->count_stok('detail_barang', $b['id_barang']); ?>
                                    <a href="<?= base_url('barang/detailBarangId/') . $b['id_barang'] ?>" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                                </td>
                                <td><?= $this->admin->stokById('detail_barang', 'BM', $b['id_barang']); ?></td>
                                <td><?= $b['nama_satuan']; ?></td>
                                <td>
