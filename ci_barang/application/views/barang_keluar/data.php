            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <?= $this->admin->stokById('detail_barang', 'BK', $bk['id_barang']); ?>
                            </td>
                            <td>
                                <?= $this->admin->count_stok('detail_barang', $bk['id_barang']); ?>
                            </td>
                            <td> <?= $bk['nama_satuan']; ?></td>
                            <td><a href="<?= base_url('barang/detailBarangKeluarId/') . $bk['id_barang'] ?>" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                            </td>
                            <td><?= $bk['nama']; ?></td>
                            <td>
