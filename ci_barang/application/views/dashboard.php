                        ...
                        <div class="col mr-2">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $stok_bm;  ?></div>
                                </div>
                                <div class="col-auto">
            ...
            <div class="table-responsive">
                <table class="table mb-0 text-center table-striped table-sm">
                    ...
                    <tbody>
                        ...
                        ?>
                                <?php $bm = ($this->admin->count_stok('detail_barang', $b['id_barang'])); ?>
                                <?php $bk = ($this->admin->stokById('detail_barang', 'BK', $b['id_barang'])); ?>
                                <tr>
                                    <td><?= $b['nama_barang']; ?></td>
                                    <td><?= $bm - $bk; ?></td>
                                    <td>
                                        <a href="<?= base_url('barang/detailBarangId/') . $b['id_barang'] ?>" class="btn btn-warning btn-sm"><i class="fa fa-plus"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else : ?>
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_masuk'] as $tbm) : ?>
                            <tr>
                                ...
                                <td><span class="badge badge-success"><?= $this->admin->count_stok('detail_barang', $tbm['id_barang']); ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_keluar'] as $tbk) : ?>
                            <tr>
                                ...
                                <td><span class="badge badge-danger"><?= $this->admin->stokById('detail_barang', 'BK', $tbk['id_barang']); ?></span></td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
