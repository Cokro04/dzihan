            ...
            <tbody>
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= base_url('barang/detailBarangId/') . $bm['id_barang'] ?>" class="btn btn-warning btn-circle btn-sm"><i class="fa fa-edit"></i></a>
                                <?= $this->admin->count_stok('detail_barang', $bm['id_barang']); ?>
                                <?= $bm['nama_satuan']; ?>
                            </td>
                            <td><?= $bm['nama']; ?></td>
                            <td>
