    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <?= form_open('', [], ['id_detail_barang' => $barang['id_detail_barang']]); ?>
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="id_barang">Nama Barang</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('id_barang', $barang['id_barang']); ?>" name="id_barang" id="id_barang" type="text" class="form-control" placeholder="Nama Barang...">
